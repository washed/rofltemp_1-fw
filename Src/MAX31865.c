...
const uint32_t MAX31865_DEVICES_CS_BANK_PIN[ MAX31865_MAX_DEVICES ][ 2 ] = { { MAX31865_0_CS_BANK, MAX31865_0_CS_PIN },
                                                                             { MAX31865_1_CS_BANK, MAX31865_1_CS_PIN },
                                                                             { MAX31865_2_CS_BANK, MAX31865_2_CS_PIN },
                                                                             { MAX31865_3_CS_BANK,
                                                                               MAX31865_3_CS_PIN } };

const uint32_t MAX31865_DEVICES_DR_BANK_PIN[ MAX31865_MAX_DEVICES ][ 2 ] = { { MAX31865_0_DR_BANK, MAX31865_0_DR_PIN },
    ...
    if ( ( MAX31865_FAULT_STATUS[ device_num ] == 0 ) &&
         ( MAX31865_DEVICES_SAMPLE_READY[ device_num ] ||
           ( HAL_GPIO_ReadPin( MAX31865_DEVICES_DR_BANK_PIN[ device_num ][ 0 ],
                               MAX31865_DEVICES_DR_BANK_PIN[ device_num ][ 1 ] ) == GPIO_PIN_RESET ) ) )
    {
